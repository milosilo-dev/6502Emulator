...
#[inline(always)]
pub(super) fn color_from_bit(bit: u8) -> u32 {
    if bit == 0 {
        0x00000000
    } else {
        0xFFFFFFFF
...
#[rustfmt::skip]
pub(super) static MICROKNIGHT_FONT: [u8; ((128 * 128) / u8::BITS) as usize] = [
...
#[rustfmt::skip]
pub(super) static MICROKNIGHT_LAYOUT: [(u8, u8); 224] = [
